  ...
  return new Vuex.Store({
    state: () => ({
      users: [
        {
          name: "Ha Huy Giap",
          email: "giapha2905@gmail.com",
          password: "Hahuygiap95",
          address: "Can tho",
          phone: "123234123"
        },
        {
          ...
          models: [
            {
              ...
              images: [
                "/images/cars/bugatti-divo-1.jpg",
                "/images/cars/bugatti-divo-2.jpg",
                "/images/cars/bugatti-divo-3.jpg",
                "/images/cars/bugatti-divo-4.jpg",
                "/images/cars/bugatti-divo-5.jpg",
                "/images/cars/bugatti-divo-6.jpg",
                "/images/cars/bugatti-divo-7.jpg"
              ],
              informations: {
            ...
            },
            {
              name: "Bugatti Veyron",
              images: [
                "/images/cars/bugatti-veyron-1.jpg",
                "/images/cars/bugatti-veyron-2.jpg",
                "/images/cars/bugatti-veyron-3.jpg",
                "/images/cars/bugatti-veyron-4.jpg",
                "/images/cars/bugatti-veyron-5.jpg",
                "/images/cars/bugatti-veyron-6.jpg",
                "/images/cars/bugatti-veyron-7.jpg"
              ],
              informations: {
          ...
          models: [
            {
              name: "Ferrari 458",
              images: [
                "/images/cars/Ferrari-458-1.jpg",
                "/images/cars/Ferrari-458-2.jpg",
                "/images/cars/Ferrari-458-3.jpg",
                "/images/cars/Ferrari-458-4.jpg"
              ],
              informations: {
                overall_dimensions_dxRxC: "4,462 x 1,998 x 1,204",
                cylinder_capacity: "7993",
            ...
            },
            {
              name: "Ferrari 488",
              images: [
                "/images/cars/Ferrari-488-1.jpg",
                "/images/cars/Ferrari-488-2.jpg",
                "/images/cars/Ferrari-488-3.jpg",
                "/images/cars/Ferrari-488-4.jpg",
                "/images/cars/Ferrari-488-5.jpg",
                "/images/cars/Ferrari-488-6.jpg",
                "/images/cars/Ferrari-488-7.jpg"
              ],
              informations: {
          ...
          models: [
            {
              ...
              images: [
                "/images/cars/lamborghini-aventador-lp700-1.jpg",
                "/images/cars/lamborghini-aventador-lp700-2.jpg",
                "/images/cars/lamborghini-aventador-lp700-3.jpg",
                "/images/cars/lamborghini-aventador-lp700-4.jpg",
                "/images/cars/lamborghini-aventador-lp700-5.jpg"
              ],
              informations: {
                overall_dimensions_dxRxC: "2030  x 2700 x 1136",
                cylinder_capacity: "3.9",
                engine:
                  "V12, 60o with electronically controlled variable valve system",
                maximum_power: "700 VC (515 kW) at 8250 rpm ",
                maximum_torque: "690 Nm (509 lbft) at 5500 rpm",
                fuel_consumption:
                  "Unleaded gasoline, octane number (RON) 95/98",
                origin: "Europe",
                gear: "F1 . 7-speed automatic",
                seats: "2"
              },
            ...
            },
            {
              ...
              images: [
                "/images/cars/Lamborghini-huracan-lp610-1.jpg",
                "/images/cars/Lamborghini-huracan-lp610-2.jpg",
                "/images/cars/Lamborghini-huracan-lp610-3.jpg",
                "/images/cars/Lamborghini-huracan-lp610-4.jpg",
                "/images/cars/Lamborghini-huracan-lp610-5.jpg"
              ],
              informations: {
      ...
      blogs: [
        {
          ...
          contents: [
            {
              subImg: "/images/blogs/sub1-1.webp",
              content:
            ...
            {
              subImg: "/images/blogs/sub1-2.webp",
              content:
        ...
        },
        {
          ...
          contents: [
            {
              subImg: "/images/blogs/sub2-1.jpg",
              content:
                "The Huracán Super Trofeo EVO2 makes the design of the previous generations more extreme, heralding stylistic elements that will make their debut on the roads in the forthcoming years. The front changes radically, featuring new combination lights and the pronounced “omega” lip that reinforces the styling bond with the Huracán STO. The “air curtain” intakes that optimize air flow are also unprecedented."
            },
            {
              subImg: "/images/blogs/sub2-2.jpg",
              content:
                "The steel front discs have been increased from 380 to 390 mm. The new calipers can house pads with a new design and a larger surface to optimize performance and fuel consumption. The propulsion is entrusted to the 5.2-liter V10 intake engine that delivers up to 620 CV, to be managed with a sequential six-gear X-Trac gearbox and matched with rear wheel drive."
            }
          ]
        },
        {
          ...
          contents: [
            {
              subImg: "/images/blogs/sub3-1.jpg",
              content:
            ...
            {
              subImg: "/images/blogs/sub3-2.jpg",
              content:
      ...
      async nuxtServerInit(store, app) {
        ...
        function openInDefaultBrowser(url) {
          ...
          if (isWebView()) {
            ...
            // If not in a WebView, simply navigate to the link
